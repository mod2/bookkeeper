	<div id="view" >
		...
		<ul id="stats">
			<?php if ($args->current_book->getPagesLeft() > 0): ?><li><h3>Pages per day</h3><span id="pagesperday"><?php echo $args->current_book->getPagesPerDay(); ?></span></li>
			<li><h3>Pages left</h3><span id="pagesleft"><?php echo $args->current_book->getPagesLeft(); ?></span></li>
			<li><h3>Days left</h3><span id="daysleft"><?php echo $args->current_book->getDaysLeft(); ?></span></li><?php else: ?>
			<li><h3>Start date</h3><span id="startdate"><?php echo date("j M", strtotime($args->current_book->getStartDate())); ?></span></li><?php endif; ?>
